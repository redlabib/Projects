...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/edit_profilee.css">
	</head>
...
<?php include ('includes/session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="BeeFriends"><b>BeeFriends</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
...
<form method="post">
				...
				<tr>
					...
					<td><input type="text" name="number" value="<?php echo $number; ?>" placeholder="204...." maxlength="13" class="form-1" title="Enter your mobile number" required /></td>
				</tr>
			</table>
		</fieldset>
